                ...
                content: [
                    {
                        text: [
                            ...
                            {text: chklenStr('  '+ClearNextYear(data.leave_num1)+'  ',0.35),fontSize:16,decoration: 'underline',decorationStyle: 'dotted'},
                            {text:'วันทำการ มีสิทธิลาพักผ่อนประจำปีนี้อีก 10 วันทำการ รวมเป็น',fontSize:16},
                            {text: chklenStr('  '+ClearNextYear(data.leave_num2)+'  ',0.35),fontSize:16,decoration: 'underline',decorationStyle: 'dotted'},
                                ...
                                '<tr>'+//ตารางสรุป
                                    '<td>'+
                                        '<table border="1" style="font-size:16px;">'+
                                            ...
                                            '</tr>'+
                                            '<tr>'+
                                                '<td>'+ClearNextYear(data.leave_num3)+'</td>'+
                                                '<td>'+data.leave_num4+'</td>'+
                                                '<td>'+ClearNextYear(data.leave_num5)+'</td>'+
                                            '</tr>'+
                                        '</table>'+
                                    '</td>'+
                                '</tr>'+
                                ...
                                '<tr>'+//ตารางสรุป
                                    '<td>'+
                                        '<table border="1" style="font-size:16px;">'+
                                            ...
                                            '</tr>'+
                                            '<tr>'+
                                                '<td>'+ClearNextYear(data.leave_num1)+'</td>'+
        ...
        var Leave_Report_module = function(){
            function Tbl(d){
                var x = "",
                    ...
                    ld2 = ['13','14','15','16'];//leave_absence_group ที่ไม่ใช่การลา
                        ...
                        '<div class="table-responsive">'+
                            '<table class="table" border="1">'+
                              '<thead >'+
                                '<tr>'+
                                    '<th style="vertical-align:middle;text-align:center;padding:0;margin:0;" rowspan="2">ว/ด/ป</th>'+
                                    '<th style="text-align:center;" colspan="4">การปฏิบัติราชการ</th>'+
                                '</tr>'+
                                '<tr>'+
                ...
                function Tbl_body1(data){
                    ...
                    var s2=0,s3=0,s1=0,s5=0,s6=0,s7=0,s9=0;
                        $.each(data,function(i,v){
                            ...
                            s5 += ( (v.leave_absence_group==='5')&&(v.status_use==='Y')  )? parseFloat(v.leave_num_day):0;
                            s6 += ( (v.leave_absence_group==='6')&&(v.status_use==='Y')  )? parseFloat(v.leave_num_day):0;
                            s7 += ( (v.leave_absence_group==='7')&&(v.status_use==='Y')  )? parseFloat(v.leave_num_day):0;
                            s9 += ( (v.leave_absence_group==='9')&&(v.status_use==='Y')  )? parseFloat(v.leave_num_day):0;
                            x+='<tr data-lid="'+v.id+'">'+
                ...
                function Tbl_body2(data){
                    var x ="";
                    var s14=0,s13=0,s15=0,s16=0;
                        $.each(data,function(i,v){
                            s14 += ( (v.leave_absence_group==='14')&&(v.status_use==='Y')  )? parseFloat(v.leave_num_day):0;
                            s13 += ( (v.leave_absence_group==='13')&&(v.status_use==='Y')  )? parseFloat(v.leave_num_day):0;
                            s15 += ( (v.leave_absence_group==='15')&&(v.status_use==='Y')  )? parseFloat(v.leave_num_day):0;
                            s16 += ( (v.leave_absence_group==='16')&&(v.status_use==='Y')  )? parseFloat(v.leave_num_day):0;
                           x+='<tr data-lid="'+v.id+'">'+
                                    '<td>'+( (v.leave_date)?$.fn.StrThaiDate3( new Date(v.leave_date) ):''  )+'</td>'+
