(function($){  
    ...
    '<div class="container-fluid">'+
        '<a href="#" id="btnShowHideMN" class="chayanon-a-img-3lineMN">'+
            '<img src="../img/3lineMN.png" style="width:22px;height:22px;" class="img-responsive" />'+
        '</a>'+
        '<div class="row">'+
            '<div class="col-xs-12 col-md-2 no-gutter nav-side-menu">'+
                '<div class="row-fluid" id="brand">'+
                    '<div class="span6" style="padding:0;margin:0;text-align:center;">'+
                        '<a href="http://nav.cx/gfZioUq"><img src="../img/hr_line.png" alt="HR@SKPH" height="26" border="0"></a>'+
                    '</div>'+
                    '<div class="span6" style="padding:0;margin:0;"></div>'+
                '</div>'+
                '<i class="fa fa-bars fa-2x toggle-btn" data-toggle="collapse" data-target="#menu-content" id="btnTrigger"></i>'+
                '<div class="menu-list">'+
                    '<ul id="menu-content" class="menu-content">'+//collapse out
                        '<li>'+
                            '<a href="#hrDashboard"><i class="fa fa-dashboard fa-lg"></i> HR-Dashboard</a>'+
                        '</li>'+
                        '<li data-toggle="collapse" data-target="#ULProfile" class="collapsed">'+
                            '<a href="#"><i class="fa fa-user fa-lg"></i> Profile <span class="arrow"></span></a>'+
                        '</li>'+
                            '<ul class="sub-menu collapse" id="ULProfile">'+
                                '<li><a href="#Profile1">ข้อมูลเบื้องต้น</a></li>'+
                                '<li><a href="#Profile2">ประวัติการเลื่อนเงินเดือน</a></li>'+
                                '<li><a href="#Profile3">ข้อมูลฝึกอบรม/พัฒนา</a></li>'+
                            '</ul>'+
                        '<li data-toggle="collapse" data-target="#LeaveAbsence" class="collapsed">'+
                            '<a href="#"><i class="fa fa-globe fa-lg"></i> ระบบวันลา <span class="arrow"></span></a>'+
                        '</li>'+
                            '<ul class="sub-menu collapse" id="LeaveAbsence">'+
                                '<li><a href="#Leave1">ยื่นใบลา</a></li>'+
                                '<li><a href="#Leave2">ตรวจสอบวันลา</a></li>'+
                            '</ul>'+
                        '<li data-toggle="collapse" data-target="#Gogov" class="collapsed">'+
                            '<a href="#"><i class="fa fa-plane fa-lg"></i> ระบบไปราชการ <span class="arrow"></span></a>'+
                        '</li>'+
                            '<ul class="sub-menu collapse" id="Gogov">'+
                                '<li><a href="#gogov1">เขียนบันทึกไปราชการ</a></li>'+
                                '<li><a href="#gogov2">เขียนรายงานการเดินทาง</a></li>'+
                                '<li><a href="#gogov3">ข้อมูลไปราชการ</a></li>'+
                            '</ul>'+
                        '<li>'+
                        '<li data-toggle="collapse" data-target="#PmProject" class="collapsed">'+
                            '<a href="#"><i class="fa fa-users fa-lg"></i> ฝึกอบรม/พัฒนา(ใน ร.พ.) <span class="arrow"></span></a>'+
                        '</li>'+
                            '<ul class="sub-menu collapse" id="PmProject">'+
                                '<li><a href="#PmProject1">สรุปโครงการฝึกอบรม/พัฒนา(ผู้จัด)</a></li>'+
                                '<li><a href="#PmProject2">ข้อมูลฝึกอบรม/พัฒนา(ใน ร.พ.)</a></li>'+
                            '</ul>'+
                        '<li>'+
                ...
                '</div>'+//menu-list
            '</div>'+//nav-side-menu
            '<div  id="myContent" class="col-xs-12 col-md-10 no-gutter">content</div>'+//class="col-xs-12 col-sm-10"   
        '</div>'+//row       
    '</div>';//container-fluid
        return txt;
    };
    var switchModule = function(hrefID){
        switch(hrefID){
            ...
            case '#Profile3'://ข้อมูล profile ข้อมูลฝึกอบรมพัฒนา
                myProfile_moldule(hrefID);
            break;
            case '#PmProject1'://สรุปโครงการฝึกอบรม/พัฒนา(ผู้จัด)
                PmProject_module(hrefID);
            break;
             case '#PmProject2'://ข้อมูลฝึกอบรม/พัฒนา(ใน ร.พ.)
                PmProject_module(hrefID);
            break;
            ...
            content: [
                ...
                },
                {
                    text: [
                        ...
                        {text:chklenStr(' '+data.dep_name+' '+((data.id13_online!==data.groupwork_Boss_id13)?data.groupwork_name:''),5.5),fontSize:16,decoration: 'underline',decorationStyle: 'dotted'},
                        '\n',
                        {text: 'ที่',fontSize:18,bold:true},
                        {text:chklenStr(' '+data.officialdoc_num,3.25),fontSize:16,decoration: 'underline',decorationStyle: 'dotted'},
                        ...
                        {text: chklenStr(data.position_name+data.class_position,2.7),fontSize:16,decoration: 'underline',decorationStyle: 'dotted'},
                        '\n',
                        ...
                        '\n\n',
                        {text:'.......................',fontSize:16,color:'white'},
                        {text:'ในการนี้ ข้าพเจ้าใคร่ขออนุมัติ',fontSize:16},
                        '\n',
                        {text:'.......................',fontSize:16,color:'white'},
                        ...
                        {text:chklenStr(carType(data.car_type),1.5),fontSize:16,decoration: 'underline',decorationStyle: 'dotted'},
                        '\n',
                        {text:'.......................',fontSize:16,color:'white'},
    ...
    var gogov_print_moldule2 = function(data){
            ...
            content: [
                {
                    text:[
                        ...
                        {text: 'จำนวน ',fontSize:16},
                        {text: chklenStr(' ',0.12),fontSize:16,decoration: 'underline',decorationStyle: 'dotted'},
                        {text: ' วัน รวม ',fontSize:16},
                            ...
                            '<td>'+//เริ่มเนื้อหาทั้งหมดในนี้
                                ...
                                '<table border="1" widths="12%,70%,10%,8%">'+
                                    ...
                                    if(data.budget3_list1){
                                        if( (data.budget3_list1).indexOf('_')>=0 && (data.budget3_list1)!=='___' ){
                                            x+='<tr>'+
                                                ...
                                                '<td><p style="text-align:right;">'+$.fn.numberWithCommas($.fn.StrToNumInt($.fn.splitStrToArr(data.budget3_list1,'_')[2]))+'</p></td>'+
                                    ...
                                    if(data.budget3_list2){
                                        if( (data.budget3_list2).indexOf('_')>=0  && (data.budget3_list2)!=='___'){
                                            x+='<tr>'+
                                                ...
                                                '<td><p style="text-align:right;">'+$.fn.numberWithCommas($.fn.StrToNumInt($.fn.splitStrToArr(data.budget3_list2,'_')[2]))+'</p></td>'+
                                    ...
                                    if(data.budget3_list3){
                                        if( (data.budget3_list3).indexOf('_')>=0  && (data.budget3_list3)!=='___'){
                                            x+='<tr>'+
                                                ...
                                                '<td><p style="text-align:right;">'+$.fn.numberWithCommas($.fn.StrToNumInt($.fn.splitStrToArr(data.budget3_list3,'_')[2]))+'</p></td>'+
                                    ...
                                    if(data.budget3_list4){
                                        if( (data.budget3_list4).indexOf('_')>=0  && (data.budget3_list4)!=='___'){
                                            x+='<tr>'+
                                                ...
                                                '<td><p style="text-align:right;">'+$.fn.numberWithCommas($.fn.StrToNumInt($.fn.splitStrToArr(data.budget3_list4,'_')[2]))+'</p></td>'+
                                    ...
                                    if(data.budget3_list5){
                                        if( (data.budget3_list5).indexOf('_')>=0  && (data.budget3_list5)!=='___'){
                                            x+='<tr>'+
                                                ...
                                                '<td><p style="text-align:right;">'+$.fn.numberWithCommas($.fn.StrToNumInt($.fn.splitStrToArr(data.budget3_list5,'_')[2]))+'</p></td>'+
                                    ...
                                    x+='<tr>'+//รวมเป็นเงิน
                                        ...
                                        '<td>'+
                                              '<p style="text-align:right;">'+$.fn.numberWithCommas($.fn.StrToNumInt((data.budget3)?$.fn.numberWithCommas(parseInt(data.budget3)):''))+'</p>'+
                                        '</td>'+
                                        '<td></td>'+
                                    '</tr>'+
                                '</table>'+
                                ...
                                '<p style="text-align:left;">'+
                                    ...
                                    '<u>'+$.fn.getBathText($.fn.StrToNumInt((data.budget3)?$.fn.numberWithCommas(parseInt(data.budget3)):0))+'</u>'+
                                '</p>'+
        ...
        pdfMake.createPdf(doc1).open();
    };//print เขียนรายงานการเดินทางไปราชการ
            ...
            '<div class="container-fluid">'+
                ...
                '<form class="col-xs-12">'+//col-offset-1
                    ...
                    '<div class="row" style="border:1px solid;">'+//nth-child(7)  
                        '<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">'+  //เบิกค่าเดินทางจาก
                            ...
                            '</div>'+
                        '</div>'+    
                        '<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">'+ //เดินทางโดย    
                            '<label for="name" class="cols-sm-2 control-label">เดินทางโดย</label>'+
                            '<div class="input-group btn-group" data-toggle="buttons">'+ 
                                '<div class="row">'+
                                    '<label class="btn">'+
        ...
        .done(function(onlineUser,person,otherDep,position,classpo){
            ...
            nth12.find("a[href='#save']").click(function(e){
                ...
                var objdata = {
                    ...
                    'gogov_for':nth2.find("input[name='child22_rdo']:checked").val(),//เดินทางไปราชการเพื่อ...อบรม ประชุม  สัมมนา
    ...
    var gogov2_moldule = function(){
            ...
            $.when($.fn.def_Competency(),$.fn.def_Skill(),$.fn.def_GogovType())
                ...
                var htmlback = function(){
                    var x=  '<form class="form-horizontal">'+
                                ...
                                '<div class="form-group">'+//nth-child(3) สรุปค่าเดินทางทั้งหมด   
                                    '<div class="col-md-10 col-md-offset-1">'+
                                        '<div class="row">'+ 
                                            '<div class="col-md-6">'+  //ค่าเบี้ยเลี้ยง,ค่าที่พัก,ค่าพาหนะ
                                                ...
                                                '<div class="input-group btn-group" data-toggle="buttons">'+   
                                                    '<div class="row">'+
                                                        '<div class="col-md-3 ">'+
                                                            '<label class="btn">'+
                                                                '<input type="checkbox" name="ch3chkbox" value="1" style="display:none;"><i class="fa fa-square-o fa-2x"></i><i class="fa fa-check-square-o fa-2x"></i>&nbsp;<span>ค่าเบี้ยเลี้ยง</span>'+
                                                            '</label>'+
                                                        '</div>'+  
                                                        '<div class="col-md-9 ">'+   
                                                            '<div class="row">'+
                                                                '<div class="col-md-5 form-group">'+
                                                                    '<input type="text" style="padding-right:1px;padding-left:1px;" name="ch3txt1" class="form-control" placeholder="ค่าเบี้ยเลี้ยง(บาท)">'+   
                                                                '</div>'+
                                                                '<div class="col-md-7 form-group">'+        
                                                                    '<select name="ch3select1" class="form-control" style="padding-right:1px;padding-left:1px;">'+
                                                    ...
                                                    '<div class="row">'+
                                                        '<div class="col-md-3 ">'+
                                                            '<label class="btn">'+
                                                                '<input type="checkbox" name="ch3chkbox" value="2" style="display:none;"><i class="fa fa-square-o fa-2x"></i><i class="fa fa-check-square-o fa-2x"></i>&nbsp;<span>ค่าที่พัก</span>'+
                                                            '</label>'+
                                                        '</div>'+  
                                                        '<div class="col-md-9 ">'+  
                                                            '<div class="row">'+
                                                                '<div class="col-md-5 form-group">'+
                                                                    '<input type="text" style="padding-right:1px;padding-left:1px;" name="ch3txt2" class="form-control" placeholder="ค่าที่พัก(บาท)">'+   
                                                                '</div>'+
                                                                '<div class="col-md-7 form-group">'+        
                                                                    '<select name="ch3select2" class="form-control" style="padding-right:1px;padding-left:1px;">'+
                                                                        '<option value="เงินบำรุง">เงินบำรุง</option>'+
                                                                        '<option value="เงินงบประมาณ">เงินงบประมาณ</option>'+
                                                                        '<option value="เงินโครงการ">เงินโครงการ</option>'+
                                                                        '<option value="ทุนส่วนตัว">ทุนส่วนตัว</option>'+
                                                    ...
                                                    '<div class="row">'+
                                                        '<div class="col-md-3 ">'+
                                                            '<label class="btn">'+
                                                                '<input type="checkbox" name="ch3chkbox" value="3" style="display:none;"><i class="fa fa-square-o fa-2x"></i><i class="fa fa-check-square-o fa-2x"></i>&nbsp;<span>ค่าพาหนะ</span>'+
                                                            '</label>'+
                                                        '</div>'+  
                                                        '<div class="col-md-9 ">'+   
                                                            '<div class="row">'+
                                                                '<div class="col-md-5 form-group">'+
                                                                    '<input type="text" style="padding-right:1px;padding-left:1px;" name="ch3txt3" class="form-control" placeholder="ค่าพาหนะ(บาท)">'+   
                                                                '</div>'+
                                                                '<div class="col-md-7 form-group">'+        
                                                                    '<select name="ch3select3" class="form-control" style="padding-right:1px;padding-left:1px;">'+
                                                                        '<option value="เงินบำรุง">เงินบำรุง</option>'+
                                                                        '<option value="เงินงบประมาณ">เงินงบประมาณ</option>'+
                                                                        '<option value="เงินโครงการ">เงินโครงการ</option>'+
                                                                        '<option value="ทุนส่วนตัว">ทุนส่วนตัว</option>'+
                                            ...
                                            '<div class="col-md-6">'+ //ค่าลงทะเบียน,ค่าใช้จ่ายอื่นๆ,ไม่ขอเบิกค่าใช้จ่าย   
                                                ...
                                                '<div class="input-group btn-group" data-toggle="buttons">'+ 
                                                    '<div class="row">'+
                                                        '<div class="col-md-3">'+
                                                            '<label class="btn">'+
                                                                '<input type="checkbox" name="ch3chkbox" value="4" style="display:none;"><i class="fa fa-square-o fa-2x"></i><i class="fa fa-check-square-o fa-2x"></i>&nbsp;<span>ค่าลงทะเบียน</span>'+
                                                            '</label>'+
                                                        '</div>'+  
                                                        '<div class="col-md-9">'+ 
                                                            '<div class="row">'+
                                                                '<div class="col-md-5 form-group">'+
                                                                    '<input type="text" style="padding-right:1px;padding-left:1px;" name="ch3txt4" class="form-control" placeholder="ค่าลงทะเบียน(บาท)">'+   
                                                                '</div>'+
                                                                '<div class="col-md-7 form-group">'+        
                                                                    '<select name="ch3select4" class="form-control" style="padding-right:1px;padding-left:1px;">'+
                                                                        '<option value="เงินบำรุง">เงินบำรุง</option>'+
                                                                        '<option value="เงินงบประมาณ">เงินงบประมาณ</option>'+
                                                                        '<option value="เงินโครงการ">เงินโครงการ</option>'+
                                                                        '<option value="ทุนส่วนตัว">ทุนส่วนตัว</option>'+
                                                    ...
                                                    '<div class="row">'+
                                                        '<div class="col-md-3 ">'+
                                                            '<label class="btn">'+
                                                                '<input type="checkbox" name="ch3chkbox" value="5" style="display:none;"><i class="fa fa-square-o fa-2x"></i><i class="fa fa-check-square-o fa-2x"></i>&nbsp;<span>ค่าใช้จ่ายอื่นๆ</span>'+
                                                            '</label>'+
                                                        '</div>'+  
                                                        '<div class="col-md-9">'+   
                                                            '<div class="row">'+
                                                                '<div class="col-md-5 form-group">'+
                                                                     '<input type="text" style="padding-right:1px;padding-left:1px;" name="ch3txt5" class="form-control" placeholder="ค่าใช้จ่ายอื่นๆ(บาท)">'+  
                                                                '</div>'+
                                                                '<div class="col-md-7 form-group">'+        
                                                                    '<select name="ch3select5" class="form-control" style="padding-right:1px;padding-left:1px;">'+
                                                                        '<option value="เงินบำรุง">เงินบำรุง</option>'+
                                                                        '<option value="เงินงบประมาณ">เงินงบประมาณ</option>'+
                                                                        '<option value="เงินโครงการ">เงินโครงการ</option>'+
                                                                        '<option value="ทุนส่วนตัว">ทุนส่วนตัว</option>'+
                                                    ...
                                                    '<div class="row">'+
                                                        '<div class="col-xs-6 ">'+
                                                            '<label class="btn">'+
                                                                '<input type="checkbox" name="ch3chkbox" value="6" style="display:none;"><i class="fa fa-square-o fa-2x"></i><i class="fa fa-check-square-o fa-2x"></i>&nbsp;<span>ไม่ขอเบิกค่าใช้จ่าย</span>'+
                                                            '</label>'+
                                                        '</div>'+  
                                                        '<div class="col-xs-6 "></div>'+
                                                    '</div>'+ 
                                        ...
                                        '</div>'+//row
                                    '</div>'+//col-md-8
                                '</div>'+//nth-child(3) สรุปค่าเดินทางทั้งหมด
                                '<div class="form-group">'+//nth-child(4) สรุปสาระสำคัญ
                                    ...
                                    '</div>'+
                                '</div>'+//nth-child(4) สรุปสาระสำคัญ
                                '<div class="form-group">'+//nth-child(5) การนำความรู้ที่ได้รับมาใช้
                                    ...
                                    '</div>'+
                                '</div>'+//nth-child(5) การนำความรู้ที่ได้รับมาใช้
                                '<div class="form-group">'+//nth-child(6) พัฒนางาน/องค์กร(เรื่อง/วิธีการ)
                                    ...
                                    '</div>'+
                                '</div>'+//nth-child(6) พัฒนางาน/องค์กร(เรื่อง/วิธีการ)
                                '<div class="form-group">'+//nth-child(7)ข้อเสนอแนะอื่นๆ
                                    '<span class="col-md-3 text-right">ข้อเสนอแนะอื่นๆ</span>'+
                                    '<div class="col-md-8">'+
                                        '<input type="text" name="gogovback_txtarea4" class="form-control"  rows="4">'+
                                    '</div>'+
                                '</div>'+//nth-child(7)ข้อเสนอแนะอื่นๆ
                                '<div class="form-group">'+//nth-child(8)สอดคล้องกับสมรรถนะ
                                    ...
                                    '<div class="col-md-8">'+
                                        ...
                                        '</div>'+        
                                    '</div>'+
                                '</div>'+//nth-child(8)สอดคล้องกับสมรรถนะ
                                '<div class="form-group">'+//nth-child(9)สอดคล้องกับทักษะ
                                    ...
                                    '<div class="col-md-8">'+
                                        ...
                                        '</div>'+ 
                                    '</div>'+
                                '</div>'+//nth-child(9)สอดคล้องกับทักษะ

                                '<div class="form-group">'+//nth-child(10)//สัญญายืมเงิน
                                    '<div class="col-md-11 col-md-offset-1">'+
                                        '<span class="text-right">ยืมเงินหรือไม่</span>'+
                                        '<div class="input-group">'+             
                                            '<div  class="btn-group" data-toggle="buttons" >'+
                                                '<label class="btn">'+
                                                  '<input type="radio" value="Y" name="ch10rdo" style="display:none;" ><i class="fa fa-circle-o fa-2x"></i><i class="fa fa-dot-circle-o fa-2x"></i> <span>  ใช่</span>'+
                                                '</label>'+
                                                '<label class="btn">'+
                                                  '<input type="radio" value="N" name="ch10rdo" style="display:none;" checked="checked"><i class="fa fa-circle-o fa-2x"></i><i class="fa fa-dot-circle-o fa-2x"></i> <span>  ไม่ใช่</span>'+                                                     
                                                '</label>'+
                                            '</div>'+
                                            '<input type="text" name="ch10txt1" class="hidden" placeholder="สัญญายืมเงินเลขที่">'+
                                            '<input type="text" name="ch10txt2" class="hidden" placeholder="ลงวันที่">'+
                                            '<input type="text" name="ch10txt3" class="hidden" placeholder="จำนวนเงิน(บาท)">'+
                                        '</div>'+
                                    '</div>'+
                                '</div>'+//nth-child(10) สัญญายืมเงิน
                                '<div class="form-group row">'+//nth-child(11)
                                    '<div class="col-md-8 col-md-offset-4">'+
                                        '<a href="#Update" class="btn chayanon-btn3d-orange">Update</a>'+
                                    '</div>'+
                                '</div>'+//nth-child(11) update print
                            '</form>';
                    return x;
                };
                ...
                var frm = panelBody.find('form'),
                    ...
                    nth3 = frm.children('div:nth-child(3)'),//สรุปค่าเดินทางทั้งหมด
                    nth4 = frm.children('div:nth-child(4)'),//สรุปสาระสำคัญ
                    nth5 = frm.children('div:nth-child(5)'),//การนำความรู้ที่ได้รับมาใช้
                    nth6 = frm.children('div:nth-child(6)'),//พัฒนางาน/องค์กร(เรื่อง/วิธีการ)
                    nth7 = frm.children('div:nth-child(7)'),//ข้อเสนอแนะอื่นๆ
                    nth8 = frm.children('div:nth-child(8)'),//สอดคล้องกับสมรรถนะ
                    nth9 = frm.children('div:nth-child(9)'),//สอดคล้องกับทักษะ
                    nth10 = frm.children('div:nth-child(10)'),//สัญญายืมเงิน
                    nth11 = frm.children('div:nth-child(11)');//update print
                ...
                //สมรรถนะ 3 ตัว
                var nth8ColMd = nth8.find('div.col-md-8'),
                    comptency1 = nth8ColMd.children('div:nth-child(1)').find('select'),
                    comptency2 = nth8ColMd.children('div:nth-child(2)').find('select'),
                    comptency3 = nth8ColMd.children('div:nth-child(3)').find('select');
                //ทักษะ 3 ตัว
                var nth9ColMd = nth9.find('div.col-md-8'),
                    skill1 = nth9ColMd.children('div:nth-child(1)').find('select'),
                    skill2 = nth9ColMd.children('div:nth-child(2)').find('select'),
                    skill3 = nth9ColMd.children('div:nth-child(3)').find('select');
                ...
                nth1.find("a[href='#CalcBL']").click(function(e){//ปุ่มกดคำนวณเบี้ยเลี้ยง
                    ...
                    var days = parseInt(datediffArr[0]),
                        ...
                        $("input[name='ch3txt1']").val(Bath);
                        $("input[name='ch3chkbox'][value='1']").prop('checked',true);
                });
                            
                //ปุ่มคลิกคำนวณค่าเดินทาง
                nth2.find("a[href='#CalcDst']").click(function(e){
                    ...
                    $("input[name='ch3txt3']").val(sum);
                    $("input[name='ch3chkbox'][value='3']").prop('checked',true);
                });
                            
                //event กรอกประมาณการค่าใช้จ่าย(checkbox)
                nth3.find("input[type=text]")//.myNumberic()//บังคับป็น Numberic เพื่อสรุปค่าใช้จ่าย กลายเป็นพิมพ์หลักพัน ไม่ได้เลยไม่ใช้
                ...
                $("input[name='ch3chkbox']").change(function(){//เหตุการณ์กรอกประมาณการค่าใช้จ่าย(checkbox)
                    ...
                    if(chkboxVal==="6"){//ไม่ขอเบิกค่าใช้จ่ายให้เคลียร์ทุกอย่าง
                        nth3.find("input[type=text]").val("");
                        nth3.find("input[type=checkbox]").not($this).prop("checked",false);
                    }
                });
                            
                //event ยืมเงินหรือไม่
                $("input[name='ch10txt2']").ConfigDatePicker2();
                $("input[name='ch10txt3']");//.myNumberic();
                $("input[name='ch10rdo']").change(function(){
                ...
                $.each(dtgogovBack[0],function(i,v){
                    if(i==='gogov_type'){//ประเภทไปราชการ แบบละเอียด เช่นประชุมที่มีระเบียบวาระการประชุม
                        var arr;
                        if(v){
                            nth1.find("select >option[value='"+v+"']").prop('selected',true);
                        }
                    }else if(i==='datediff'){//array เก็บข้อมูล ระยะเวลาไปราชการ field datediff
                        if(v){
                            datediffArr = v.split(",");
                        }
                    }else if(i==='go_from'){//โดยออกเดินทางจาก...  บ้านพัก สำนักงาน ประเทศไทย
                        $("input[name='BLrdo1'][value='"+v+"']").prop('checked',true);
                    }else if(i==='go_from_date'){//โดยออกเดินทางจาก... วัน เวลา
                        $("input[name='BLtxt11']").val(v);
                    }else if(i==='go_back'){//และกลับถึง ... บ้านพัก สำนักงาน ประเทศไทย
                        $("input[name='BLrdo2'][value='"+v+"']").prop('checked',true);
                    }else if(i==='go_back_date'){//และกลับถึง....วัน เวลา
                        $("input[name='BLtxt21']").val(v);
                    }else if(i==='budget1'){//ค่าเบี้ยเลี้ยง.... บาท
                        $("input[name='ch3txt1']").val(v);
                    }else if(i==='budget2'){//ค่าที่พัก.... บาท
                        $("input[name='ch3txt2']").val(v);
                    }else if(i==='budget3'){//ค่าพาหนะ.... บาท
                        $("input[name='ch3txt3']").val(v);
                    }else if(i==='budget4'){//ค่าลงทะเบียน.... บาท
                        $("input[name='ch3txt4']").val(v);
                    }else if(i==='budget5'){//ค่าใช้จ่ายอื่น.... บาท
                        $("input[name='ch3txt5']").val(v);
                    }else if(i==='addr_from'){//โดยออกเดินทางจากบ้านพักเลขที่......ที่อยู่
                        $("input[name='ch2row1txt1']").val(v);
                    }else if(i==='addr_back'){//กลับถึงบ้านพักเลขที่....ที่อยู่
                        $("input[name='ch2row1txt2']").val(v);
                    }else if(i==='budget3_list1'){//รายละเอียดค่าพาหนะ...บรรทัดที่1
                        var arr;
                        if(v){
                            arr = v.split("_");
                    ...
                    }else if(i==='budget3_list2'){//รายละเอียดค่าพาหนะ...บรรทัดที่2
                        var arr;
                        if(v){
                            arr = v.split("_");
                    ...
                    }else if(i==='budget3_list3'){//รายละเอียดค่าพาหนะ...บรรทัดที่3
                        var arr;
                        if(v){
                            arr = v.split("_");
                    ...
                    }else if(i==='budget3_list4'){//รายละเอียดค่าพาหนะ...บรรทัดที่4
                        var arr;
                        if(v){
                            arr = v.split("_");
                    ...
                    }else if(i==='budget3_list5'){//รายละเอียดค่าพาหนะ...บรรทัดที่5
                        var arr;
                        if(v){
                            arr = v.split("_");
                    ...
                    }else if(i==='conclude'){//สรุปสาระสำคัญ
                        $("input[name='gogovback_txtarea1']").val(v);
                    }else if(i==='know_how_used1'){//การนำความรู้ที่ได้รับมาประยุกต์ใช้....ด้านพัฒนาตน
                        $("input[name='gogovback_txtarea2']").val(v);
                    }else if(i==='know_how_used2'){//การนำความรู้ที่ได้รับมาประยุกต์ใช้....พัฒนางาน องค์กร
                        $("input[name='gogovback_txtarea3']").val(v);
                    }else if(i==='know_how_used3'){//การนำความรู้ที่ได้รับมาประยุกต์ใช้....ข้อเสนอแนะอื่นๆ
                        $("input[name='gogovback_txtarea4']").val(v);
                    }else if(i==='competency'){//สมรรถนะ1
                        if(v){
                            comptency1.children("option[value='"+v+"']").prop('selected',true);
                        }
                    }else if(i==='competency2'){//สมรรถนะ2
                        if(v){
                            comptency2.children("option[value='"+v+"']").prop('selected',true);
                        }
                    }else if(i==='competency3'){//สมรรถนะ3
                        if(v){
                            comptency3.children("option[value='"+v+"']").prop('selected',true);
                        }
                    }else if(i==='skill'){//ทักษะ1
                        if(v){
                            skill1.children("option[value='"+v+"']").prop('selected',true);
                        } 
                    }else if(i==='skill2'){//ทักษะ2
                        if(v){
                            skill2.children("option[value='"+v+"']").prop('selected',true);
                        } 
                    }else if(i==='skill3'){//ทักษะ3
                        if(v){
                            skill3.children("option[value='"+v+"']").prop('selected',true);
                        } 
                    }else if(i==='agreement'){//ยืมเงินหรือไม่
                        var arr;
                        if(v){
                            arr = v.split("_");
                            $("input[name='ch10rdo'][value='Y']").prop('checked',true);
                            $("input[name='ch10txt1']").val(arr[0]).removeClass('hidden').show();
                            $("input[name='ch10txt2']").val(arr[1]).removeClass('hidden').show();
                            $("input[name='ch10txt3']").val(arr[2]).removeClass('hidden').show();
                        }
                    }
                });
                
                //update ลงฐานข้อมูล gogov_back
                nth11.find("a[href='#Update']").click(function(){
                    //สรุปจำนวนเงินค่าใช้จ่ายไปราชการ
                    var bd1 = (isNaN(parseFloat($("input[name='ch3txt1']").val()))) ? 0 : parseFloat($("input[name='ch3txt1']").val());
                    var bd2 = (isNaN(parseFloat($("input[name='ch3txt2']").val()))) ? 0 : parseFloat($("input[name='ch3txt2']").val());
                    var bd3 = (isNaN(parseFloat($("input[name='ch3txt3']").val()))) ? 0 : parseFloat($("input[name='ch3txt3']").val());
                    var bd4 = (isNaN(parseFloat($("input[name='ch3txt4']").val()))) ? 0 : parseFloat($("input[name='ch3txt4']").val());
                    var bd5 = (isNaN(parseFloat($("input[name='ch3txt5']").val()))) ? 0 : parseFloat($("input[name='ch3txt5']").val());
                    //console.log(bd1,bd2,bd3,bd4,bd5);
                    //สรุปรายละเอียดค่าพาหนะ 5 บรรทัด
                    ...
                    //สัญญายืมเงิน
                    var agreement = $("input[name='ch10txt1']").val()+'_'+$("input[name='ch10txt2']").val()+'_'+$("input[name='ch10txt3']").val();
                    ...
                    //บันทึกลงฐาน
                    if( parseFloat(obj.datediff[0]) > 0 ||  parseFloat(obj.datediff[1]) > 0 ||  parseFloat(obj.datediff[2]) > 0){//วันเดินทางไป และกลับ ห่างกัน อย่างน้อย 1 นาที
                        if( (obj.competency) || (obj.competency2) || (obj.competency3) || (obj.skill) || (obj.skill2) || (obj.skill3) )  {
        ...
        function gogovBackData(data){//console.log(data);
            ...
            tbl.find("a[href='#gogovData']").click(function(e){
                ...
                var AcceptPersonFinanceID = ['18','235'];//บุคลากรการเงิน ยกเว้น สามารถเข้ามาแก้รายงานการเดินทางได้
                $.each(data,function(i,v){
                    if(parseInt(v.id)===idgogovdata){
                        $.when($.fn.def_OnlineUser()).done(function(OnlineUser){
                            if(  (OnlineUser.person_id===v.person_id) || ( $.inArray(OnlineUser.person_id,AcceptPersonFinanceID) !== -1)    ){//ถ้าเป็นเจ้าของรายการนั้นจะเขียนรายงานการเดินทางได้
    ...
    var myProfile_moldule = function(hrefID){
        ...
        var profile1 = function(onlineUser){
            var form = function(){
                var x = 
                '<div class="container">'+
            ...
            var ch1 = content.find('div.container').children('div:nth-child(1)'),
                ch2 = content.find('div.container').children('div:nth-child(2)');
            var ch2frm1 = ch2.find('form').first(),//form upload รูป profile
                ch2frm2 = ch2.find('form').last(),
                btnlogout = ch2frm1.find('p >a');
            //html action
            ch1.find('h2').empty().append(replacePname(onlineUser.pname));
            ch2frm2.find('input[type=text]').each(function(i){
                ...
                if(i===2){$(this).val(onlineUser.dep_name);}
    ...
    var LeaveAbsence_module = function(SubModuleID){
        var Content = $("#myContent");
        var Print_module = function(data,OnlineUser){//console.log(data);
            function splitDate(txtDate){
                var arr = txtDate.split(' ');
                var day =  (arr[0].toLowerCase().indexOf('0') >= 0) ? arr[0].replace('0',''):arr[0];
                return [day,arr[1],arr[2]];
            };
            function splitDate2(txtDate){
                var arr = [];
                ...
                content: [
                    {
                        text: [
                            ...
                            '\n\n',
                            {text: 'เรียน ผู้อำนวยการโรงพยาบาล',fontSize:16,alignment: 'left'},
                            '\n\n',
                            ...
                            {text:'สังกัด',fontSize:16},
                            {text: chklenStr('  '+data.dep_name+'  '+data.groupwork_name+'  ',4.5),fontSize:16,decoration: 'underline',decorationStyle: 'dotted'},
                            '\n',
                            {text:'มีวันลาพักผ่อนสะสม',fontSize:16},
                            {text: chklenStr('  '+data.leave_num1+'  ',0.35),fontSize:16,decoration: 'underline',decorationStyle: 'dotted'},
                            {text:'วันทำการ มีสิทธิลาพักผ่อนประจำปีนี้อีก 10 วันทำการ รวมเป็น',fontSize:16},
                            {text: chklenStr('  '+data.leave_num2+'  ',0.35),fontSize:16,decoration: 'underline',decorationStyle: 'dotted'},
                ...
                content: [
                    {
                        text: [
                            ...
                            {text: chklenStr($.fn.StrThaiDate4(new Date(splitDate2(data.last_leave_date)[0])),0.45),fontSize:16,decoration: 'underline',decorationStyle: 'dotted'},
                            '\n',
                            {text:'ถึง ',fontSize:16},
                            {text: chklenStr($.fn.StrThaiDate4(new Date(splitDate2(data.last_leave_date)[1])),0.45),fontSize:16,decoration: 'underline',decorationStyle: 'dotted'},
                            {text:' ในระหว่างลาจะติดต่อข้าพเจ้าได้ที่',fontSize:16},
            ...
            function htmlTblLeave1(data){
                var txtBoss1 = (OnlineUser.id13_online===OnlineUser.groupwork_Boss_id13)?'.........................................':data.Boss_pname;
                var txtBoss2 = (OnlineUser.id13_online===OnlineUser.groupwork_Boss_id13)?'.........................................':data.Boss_position_name+data.Boss_class_position;
                var x =
                '<table  style="font-size:16px;">'+
                    '<tr>'+
                        '<td>'+//col-1
        ...
        var Leave_send_module = function(){
                ...
                var x = 
                    '<div class="container chayanon-header">'+
                        '<div class="row overlay">'+//nth-child(1)
                                '<p style="font-size:96px;font-weight: bold;" class="thsarabunnew">ยื่นใบลา</p>'+
                        '</div>'+
                        ...
                        '<div class="row hidden">'+//nth-child(6)
                            '<div class="col-md-8 text-left">'+
                                ...
                                '<input type="text" name="txtNote" placeholder="หมายเหตุ..." class="form-control noradius">'+
                            '</div>'+
                        '</div>'+
            ...
            $.when($.fn.def_OnlineUser()).done(function(OnlineUser){
                $.when(
                    ...
                    $.fn.def_CallLeaveParam({'person_id':OnlineUser.person_id,'leave_year_gov':new Date(OnlineUser.dateNow2).getFullYear()})
                    ...
                    var ch2 = container.children('div:nth-child(2)'),//select ประเภทการลา
                        ...
                        ch6 = container.children('div:nth-child(6)'),//หมายเหตุ
                    ...
                    var json_print_func = function(leave_type){
                        ...
                        var json_print = {
                            ...
                            'leave_txt_note':chkStr(objData[0].leave_txt_note),//หมายเหตุ
                        ...
                        var txtDatetime = function(){
                            ...
                            $.each(objData,function(i,v){
                                ...
                                if(real_firstday.length!==0&&real_lastday.length!==0){
                                    ...
                                    if( sumleave === diff  ){//console.log('ต่อเนื่อง');
                                        cnts = true;
                                    }else{//console.log('ไม่ต่อเนื่อง');
                                        cnts = false;
                                    }
                                };
                                if(cnts){
                                ...
                                switch(f){
                                    ...
                                    case 'f2'://หาวันที่ลาครั้งล่าสุด
                                        ...
                                        $.each(LeaveData,function(i,v){//หา serialuse ที่ไม่ซ้ำกัน
                                            if(leave_id===v.leave_absence_id){
                                                if($.inArray(v.serialuse,s)===-1){//เอา serialuse ที่ไม่ซ้ำกัน
                                                    s.push(v.serialuse);
                                                }
                                            }
                                        });
                                        $.each(LeaveData,function(i,v){//หาวันแรกและวันสุดท้ายของ serialuse ครั้งล่าสุด
                                            if(leave_id===v.leave_absence_id){
                                                if(v.serialuse===s[s.length -1]){
                                                    dd.push(v.leave_date);
                                                }
                                            }
                                        });
                                        if(dd.length!==0){
                                            returnV = dd[0]+','+dd[dd.length-1];
                                        }else{
                    ...
                    ch7.find('button').click(function(){
                        ...
                        var dd1 = (d1.val())?d1.data('date_true'):'';
                        var dd2 = (d2.val())?d2.data('date_true'):'';
                        if($.inArray($("select[name='leave_id']").val(),ContinousLeave) !== -1){//การลาที่เต็มวันทุกวัน นับวันหยุด และต่อเนื่องติดกันหลายวัน เช่น ลาคลอด,อุปสมบท ไม่ต้องเลือกทีละวัน  ค่อยไปเก็บค่าตอนกดบันทึก
                            if($.fn.DaysBetweenDate(dd1,dd2)!=='error'){
                                days.length = 0;
                                days = $.fn.DaysBetweenDate(dd1,dd2);//เก็บวันที่ไว้ใน array 
                                if(days.length >0){
                        ...
                        var json_print_one = function(){
                            ...
                            if(x){
                                return json_print_func(leave_id);
                            }else{
                                return {};
                            }
                        ...
                        if(objData.length>0){
                            msg.html("");
                            $.ajax({
                                url:"UserLeaveSend.php", 
                                type:"post",
                                cache:false,
                                dataType:'json',
                                data:{'d':JSON.stringify(objData)}
                            }).done(function(data){
                                var txtmodal = function(){
                                                ...
                                                '<div class="modal-body">'+
                                                        '<div class="row">'+
                                                            '<h3 style="padding:15px;margin:15px">'+
                                                                ...
                                                                'ท่านได้<u>พิมพ์เอกสารฉบับนี้</u>&#9755;&nbsp;'+
                                                                '<button type="button"  class="btn chayanon-btn3d-orange" style="color:black;">Print</button><br>'+
                                                                'แล้วนำไปเสนอต่อผู้บังคับบัญชาพิจารณาอนุญาตเท่านั้น'+
                                                            '</h3>'+
                                                        '</div>'+
                                                '</div>'+
                                                '<div class="modal-footer">'+
                                                    '<button type="button"  class="btn btn-lg btn-danger" style="color:white;">ปิด</button>'+//data-dismiss="modal"
                                                '</div>'+
                                            '</div>'+
                                        '</div>'+
                                    '</div>';
                                ...
                                modal1.find('.modal-body .row h3 button').click(function(){//กด print
                                    Print_module($(this).closest('.modal').data('json_print'),OnlineUser);
                                });
                                modal1.find('.modal-footer button').click(function(){//คลิก OK
        ...
        var Leave_Report_module = function(){
            var htmlCallLeaveAbsence = function(onlineUser){
                var def = $.Deferred();
                var Tbl = function(data){
                    var x=
                    '<p><h3>'+
                        onlineUser.id13_online+'#'+onlineUser.pname+
                    '</h3></p>'+
                    ...
                    '<table class="table table-striped table-bordered">'+
                      '<thead style="background-color:#DFF2F6 ;">'+
                        '<tr>'+
                            '<th style="vertical-align:middle;text-align:center;padding:0;margin:0;" rowspan="2">ว/ด/ป</th>'+
                            '<th style="text-align:center;" colspan="12">ประเภทการลา</th>'+
                        '</tr>'+
                        '<tr>'+
                            ...
                            '<th class="cl4" style="text-align:center;padding:0;margin:0;">กิจ</th>'+
                            '<th class="cl6" style="text-align:center;padding:0;margin:0;">พักผ่อน</th>'+
                            '<th class="cl2" style="text-align:center;padding:0;margin:0;">คลอดบุตร</th>'+
                            '<th class="cl3" style="text-align:center;padding:0;margin:0;">ช่วยภริยาคลอดบุตร</th>'+
                            ...
                            '<th style="text-align:center;padding:0;margin:0;">สถานะรายการ</th>'+
                        '</tr>'+
                      '<thead>'+
                      '<tbody>';
                    ...
                    $.each(data,function(i,v){
                        ...
                        var txt_status_use1,txt_status_use2;
                        
                        if(v.status_use==='Y'){
                            txt_status_use1 = '<i class="fa fa-check" aria-hidden="true" style="color:#1E7007;"></i>';
                            txt_status_use2 = '<i class="fa fa-check" aria-hidden="true" style="color:#1E7007;"></i>&nbsp;อนุมัติแล้ว';
                        }else if(v.status_use==='N'){
                            txt_status_use1 = '<i class="fa fa-ban" aria-hidden="true" style="color:red;"></i>';
                            txt_status_use2 = '<i class="fa fa-ban" aria-hidden="true" style="color:red;"></i>&nbsp;ยกเลิกวันลา';
                        }else if(v.status_use==='E'){
                            txt_status_use1 = '<i class="fa fa-spinner" aria-hidden="true" style="color:blue;"></i>';
                            txt_status_use2 = '<i class="fa fa-spinner" aria-hidden="true" style="color:blue;"></i>&nbsp;รอพิจารณา';
                        }
                        
                        t1 = (v.leave_absence_group==='1')? v.leave_num_day+thalf+'&nbsp;'+txt_status_use1:'';//ลาพักผ่อน
                        t2 = (v.leave_absence_group==='2')? v.leave_num_day+thalf+'&nbsp;'+txt_status_use1:'';//ลาป่วย
                        t3 = (v.leave_absence_group==='3')? v.leave_num_day+thalf+'&nbsp;'+txt_status_use1:'';//ลากิจ
                        t4 = (v.leave_absence_group==='5')? v.leave_num_day+thalf+'&nbsp;'+txt_status_use1:'';//คลอดบุตร**
                        t5 = (v.leave_absence_group==='6')? v.leave_num_day+thalf+'&nbsp;'+txt_status_use1:'';//ช่วยภริยาคลอดบุตร
                        t6 = (v.leave_absence_group==='7')? v.leave_num_day+thalf+'&nbsp;'+txt_status_use1:'';//อุปสมบท**
                        t7 = (v.leave_absence_group==='9')? v.leave_num_day+thalf+'&nbsp;'+txt_status_use1:'';//ศึกษาต่อ**
                        t8 = (v.leave_absence_group==='13')? v.leave_num_day+thalf+'&nbsp;'+txt_status_use1:'';//สาย
                        t9 = (v.leave_absence_group==='14')? v.leave_num_day+thalf+'&nbsp;'+txt_status_use1:'';//ไปราชการ**
                        t10 = (v.leave_absence_group==='15')? v.leave_num_day+thalf+'&nbsp;'+txt_status_use1:'';//ไม่สแกนออก**
                        t11 = (v.leave_absence_group==='16')? v.leave_num_day+thalf+'&nbsp;'+txt_status_use1:'';//สแกนออกก่อน**
                        
                        s1 += ((v.leave_absence_group==='1')&&(v.status_use==='Y')) ? (parseFloat(v.leave_num_day)):0;
                        s2 += ((v.leave_absence_group==='2')&&(v.status_use==='Y')) ? (parseFloat(v.leave_num_day)):0;
                        s3 += ((v.leave_absence_group==='3')&&(v.status_use==='Y')) ? (parseFloat(v.leave_num_day)):0;
                        s4 += ((v.leave_absence_group==='5')&&(v.status_use==='Y')) ? (parseFloat(v.leave_num_day)):0;
                        s5 += ((v.leave_absence_group==='6')&&(v.status_use==='Y')) ? (parseFloat(v.leave_num_day)):0;
                        s6 += ((v.leave_absence_group==='7')&&(v.status_use==='Y')) ? (parseFloat(v.leave_num_day)):0;
                        s7 += ((v.leave_absence_group==='9')&&(v.status_use==='Y')) ? (parseFloat(v.leave_num_day)):0;
                        s8 += ((v.leave_absence_group==='13')&&(v.status_use==='Y')) ? (parseFloat(v.leave_num_day)):0;
                        s9 += ((v.leave_absence_group==='14')&&(v.status_use==='Y')) ? (parseFloat(v.leave_num_day)):0;
                        s10 += ((v.leave_absence_group==='15')&&(v.status_use==='Y')) ? (parseFloat(v.leave_num_day)):0;
                        s11 += ((v.leave_absence_group==='16')&&(v.status_use==='Y')) ? (parseFloat(v.leave_num_day)):0;
                        
                        
                    x +=   '<tr data-holiday="'+v.holiday_on_off+'" data-statususe="'+v.status_use+'">'+
                                '<td style="text-align:center;padding:0;margin:0;">'+transDate(v.leave_date)+'&nbsp;'+tholiday+'</td>'+
                                ...
                                '<td style="text-align:center;padding:0;margin:0;">'+txt_status_use2+'</td>'+
                            '</tr>';
                    });
                    
                    x+= '<tr>'+
                            '<td style="text-align:right;padding:0;margin:0;">รวม</td>'+
                            '<td style="text-align:center;padding:0;margin:0;">'+((s2===0)?"-":s2)+'</td>'+
                            '<td style="text-align:center;padding:0;margin:0;">'+((s3===0)?"-":s3)+'</td>'+
                            '<td style="text-align:center;padding:0;margin:0;">'+//ลาพักผ่อน
                                '<a href="#" class="btn btn-xs btn-success" '+    
                                   ...
                                   'data-content="" '+
                                  '>ดูสรุป<span class="glyphicon glyphicon-zoom-in"></span></a>'+
                            '</td>'+
                            '<td style="text-align:center;padding:0;margin:0;">'+((s4===0)?"-":s4)+'</td>'+
                            '<td style="text-align:center;padding:0;margin:0;">'+((s5===0)?"-":s5)+'</td>'+
                            '<td style="text-align:center;padding:0;margin:0;">'+((s6===0)?"-":s6)+'</td>'+
                            '<td style="text-align:center;padding:0;margin:0;">'+((s7===0)?"-":s7)+'</td>'+
                            '<td style="text-align:center;padding:0;margin:0;">'+((s8===0)?"-":s8)+'</td>'+
                            '<td style="text-align:center;padding:0;margin:0;">'+((s9===0)?"-":s9)+'</td>'+
                            '<td style="text-align:center;padding:0;margin:0;">'+((s10===0)?"-":s10)+'</td>'+
                            '<td style="text-align:center;padding:0;margin:0;">'+((s11===0)?"-":s11)+'</td>'+
                        '</tr>'+
                      '</tbody>'+
                    '</table>';
                ...
                $.ajax({
                    ...
                    if(typeof data !=='string'){
                        def.resolve(Tbl(data));
                    }else{
                        def.resolve('<span>Data not Found!!</span>');
                    }
                });
                return def.promise();
            };
            ...
            $.when($.fn.def_OnlineUser()).done(function(onlineUser){
                $.when(htmlCallLeaveAbsence(onlineUser),$.fn.def_LeaveAbsenceVacationSummary(onlineUser.person_id))
                    .done(function(tblLeave,VacationSummary){
                    Content.empty().append(tblLeave);
                    var rowMN = Content.find('div.menu >div.row');
        ...
        if(SubModuleID==='#Leave1'){
            Leave_send_module();
        }else if(SubModuleID==='#Leave2'){
            Leave_Report_module();
        }else{
            return false;
        }
    };//ระบบวันลา
    var PmProject_module = function(hrefID){
        if(hrefID==='#PmProject1'){
            var frm = function(){
              var x =
                    '<div class="container">'+  
                        '<div class="col-md-11">'+//nth-child(1)
                            '<legend>บันทึกข้อมูลฝึกอบรม/พัฒนา (สำหรับผู้จัดโครงการ)</legend'+
                            '<div class="panel">'+
                                '<div class="panel-body" style="border-radius: 0px 20px 0px 80px;-webkit-box-shadow: -8px -4px 6px -2px #000000;box-shadow: -8px -4px 6px -2px #000000; ">'+
                                    '<div class="form-group float-label-control">'+//nth-child(1)
                                        '<label class="control-label">ประเภท</label>'+
                                        '<select class="form-control noradius" style="margin-top:30px;">'+
                                            '<option value="อบรม">อบรม</option>'+
                                            '<option value="ประชุม">ประชุม</option>'+
                                            '<option value="สัมมนา">สัมมนา</option>'+
                                        '</select>'+
                                    '</div>'+
                                    '<div class="form-group float-label-control">'+//nth-child(2)
                                        '<label class="control-label">ชื่อโครงการ</label>'+
                                        '<input type="text" class="form-control"/>'+
                                    '</div>'+
                                    '<div class="form-group float-label-control">'+//nth-child(3)
                                        '<label class="control-label">ผู้รับผิดชอบโครงการ</label>'+
                                        '<div></div>'+//chosen ชื่อบุคลากร
                                    '</div>'+
                                    '<div class="form-group float-label-control">'+//nth-child(4)
                                        '<div class="row">'+
                                        ...
                                        '</div>'+
                                    '</div>'+
                                    '<div class="form-group float-label-control">'+//nth-child(5)
                                        '<label class="control-label">งบประมาณทั้งสิ้น(บาท)</label>'+
                                        '<input type="text" class="form-control"/>'+
                                    '</div>'+
                                    '<div class="form-group float-label-control">'+//nth-child(6)
                                        '<label class="control-label">สมรรถนะ1</label>'+
                                        '<div></div>'+//chosen
                                    '</div>'+
                                    '<div class="form-group float-label-control">'+//nth-child(7)
                                        '<label class="control-label">สมรรถนะ2</label>'+
                                        '<div></div>'+//chosen
                                    '</div>'+
                                    '<div class="form-group float-label-control">'+//nth-child(8)
                                        '<label class="control-label">สมรรถนะ3</label>'+
                                        '<div></div>'+//chosen
                                    '</div>'+
                                    '<div class="form-group float-label-control">'+//nth-child(9)
                                        '<label class="control-label">ทักษะ1</label>'+
                                        '<div></div>'+//chosen
                                    '</div>'+
                                    '<div class="form-group float-label-control">'+//nth-child(10)
                                        '<label class="control-label">ทักษะ2</label>'+
                                        '<div></div>'+//chosen
                                    '</div>'+
                                    '<div class="form-group float-label-control">'+//nth-child(11)
                                        '<label class="control-label">ทักษะ3</label>'+
                                        '<div></div>'+//chosen
                                    '</div>'+
                                    '<div class="form-group float-label-control">'+//nth-child(12)
                                        '<label class="control-label">Add รายชื่อผู้เข้าร่วมโครงการ</label>'+
                                        '<div class="row">'+
                                            '<div class="col-md-5">'+
                                                '<div class="choPersonAdd1"></div>'+//chosen ชื่อบุคลากร สำหรับ add
                                            '</div>'+
                                            '<div class="col-md-2">'+
                                                '<button class="btn btn-block noradius btnAdd">ADD&#62;&#62;</button><br>'+//ปุ่ม add
                                                '<button class="btn btn-block noradius btnRemove">&#60;&#60;Remove</button>'+//ปุ่ม remove
                                            '</div>'+
                                            '<div class="col-md-5">'+
                                                '<div class="choPersonAdd2"></div>'+//chosen ชื่อบุคลากร ตอน add แล้ว
                                            '</div>'+
                                        '</div>'+
                                    '</div>'+
                                    '<div class="form-group float-label-control col-md-6 col-md-offset-6">'+//nth-child(13)
                                        '<button class="chayanon-btn3d-blue">บันทึก</button>'+
                                    '</div>'+
                                '</div>'+//panel-body
                            '</div>'+//panel
                        '</div>'+//nth-child(1)
            ...
            function ATC_person(ajaxData){
                var x = '<select class="form-control noradius"><option value=""></option>';
                    $.each(ajaxData,function(i,v){
                        x+='<option value="'+v.id+'">'+v.pname+v.fname+' '+v.lname+'</option>';
                    });
                    x+='</select>';
            ...
            function ATC_competency(ajaxData){
                var x = '<select   class="form-control"><option value=""></option>';
                        $.each(ajaxData,function(i,v){
                            x+='<option value="'+v.id+'_'+v.competency_name+'">'+v.competency_name+'</option>';
                        });
                        x+='</select>';
            ...
            //ajax call html
            $.when($.fn.def_OnlineUser(),$.fn.def_PersonData(),$.fn.def_Competency(),$.fn.def_Skill())
            .done(function(onlineUser,person,compe,skill){
                $("#myContent").empty().append(frm);
                var pb = $("#myContent").find('.panel-body'),
                    nth1 = pb.children('div:nth-child(1)'),
                    nth2 = pb.children('div:nth-child(2)'),
                    nth3 = pb.children('div:nth-child(3)'),
                    nth4 = pb.children('div:nth-child(4)'),
                    nth5 = pb.children('div:nth-child(5)'),
                    nth6 = pb.children('div:nth-child(6)'),
                    nth7 = pb.children('div:nth-child(7)'),
                    nth8 = pb.children('div:nth-child(8)'),
                    nth9 = pb.children('div:nth-child(9)'),
                    nth10 = pb.children('div:nth-child(10)'),
                    nth11 = pb.children('div:nth-child(11)'),
                    nth12 = pb.children('div:nth-child(12)'),
                    nth13 = pb.children('div:nth-child(13)');
                nth3.find('div').empty().append(ATC_person(person));//ผู้รับผิดชอบโครงการ
                nth4.find("input[type='text']").first().ConfigDatePicker();//ระหว่างวันที่
                nth4.find("input[type='text']").last().ConfigDatePicker();//ถึงวันที่
                nth6.find('div').empty().append(ATC_competency(compe));//สมรรถนะ1
                nth7.find('div').empty().append(ATC_competency(compe));//สมรรถนะ2
                nth8.find('div').empty().append(ATC_competency(compe));//สมรรถนะ3
                nth9.find('div').empty().append(ATC_skill(skill));//ทักษะ1
                nth10.find('div').empty().append(ATC_skill(skill));//ทักษะ2
                nth11.find('div').empty().append(ATC_skill(skill));//ทักษะ3
                nth12.find('div.choPersonAdd1').empty().append(ATC_person(person));//รายชื่อสำหรับ Add
                nth12.find('div.choPersonAdd2').empty().append('<select class="form-control" multiple></select>');//รายชื่อตอน Add แล้ว
                nth3.find('select').select2();//ผู้รับผิดชอบโครงการ
                nth6.find('select').select2();//สมรรถนะ1
                nth7.find('select').select2();//สมรรถนะ2
                nth8.find('select').select2();//สมรรถนะ3
                nth9.find('select').select2();//ทักษะ1
                nth10.find('select').select2();//ทักษะ2
                nth11.find('select').select2();//ทักษะ3
                var selNth12f = nth12.find('div.choPersonAdd1 > select').select2(),//รายชื่อสำหรับ Add
                    selNth12l = nth12.find('div.choPersonAdd2 > select');//รายชื่อตอน Add แล้ว
                //event เลือกคนเข้าโครงการ
                var project_party_list_person_id = [],
                    project_party_list_person_name = [];
                nth12.find('button.btnAdd').click(function(e){
                    var selOpt = selNth12f.find('option:selected');
                    if(selOpt){
                        var o = new Option(selOpt.text(), selOpt.val());
                            $(o).html(selOpt.text()); 
                        selNth12l.append(o);  
                        selNth12l.children('option').each(function(){
                            if($.inArray($(this).val(),project_party_list_person_id) === -1){//ถ้ายังไม่มี ให้เก็บ person_id นั้นไว้
                                project_party_list_person_id.push($(this).val());
                                project_party_list_person_name.push($(this).text());
                            }
                        });
                        e.preventDefault();
                    }
                });
                nth12.find('button.btnRemove').click(function(e){
                    var selOpt = selNth12l.find('option:selected');
                    if(selOpt){
                        $.each(project_party_list_person_id,function(i,v){
                            if(  selOpt.val()===v  )   {//ลบ person_id นั้นๆ ใน array
                                project_party_list_person_id = $.grep(project_party_list_person_id, function(value) {
                                    return value !== selOpt.val();
                                });
                                project_party_list_person_name = $.grep(project_party_list_person_name, function(value) {
                                    return value !== selOpt.text();
                                });
                            }
                        });
                        selOpt.remove();//remove item
                        e.preventDefault();
                    }
                });
                nth13.find('button').click(function(){
                   var obj = {
                        develop_type:nth1.find('select > option:selected').val(),
                        project_name:nth2.find("input[type='text']").val(),
                        project_owner_person_id:nth3.find('select >option:selected').val(),
                        project_owner_name:nth3.find('select >option:selected').text(),
                        project_date1:nth4.find("input[type='text']").first().data('date_true'),
                        project_date1_th:nth4.find("input[type='text']").first().val(),
                        project_date2:nth4.find("input[type='text']").last().data('date_true'),
                        project_date2_th:nth4.find("input[type='text']").last().val(),
                        project_budget:isNaN(parseInt(nth5.find("input[type='text']").val()))?0:parseInt(nth5.find("input[type='text']").val()),
                        competency1:nth6.find('select > option:selected').val(),
                        competency2:nth7.find('select > option:selected').val(),
                        competency3:nth8.find('select > option:selected').val(),
                        skill1:nth9.find('select > option:selected').val(),
                        skill2:nth10.find('select > option:selected').val(),
                        skill3:nth11.find('select > option:selected').val(),
                        project_party_list_person_id:(project_party_list_person_id.length===0)?'':project_party_list_person_id.join('_'),
                        project_party_list_person_name:(project_party_list_person_name.length===0)?'':project_party_list_person_name.join('_'),
                        status_use:'Y'
                   };
                   var chk = true;
                   $.each(obj,function(i,v){
                      ...
                      if(i==='project_party_list_person_id'){
                          if(v===''){
                              chk=false;
                          }
                      }
                      if(i==='project_party_list_person_name'){
                          if(v===''){
                              chk=false;
                          }
                      }
        ...
        }else  if(hrefID==='#PmProject2'){
             $("#myContent").empty().append('ขออภัย อยู่ระหว่างดำเนินการ');
        }
    };
    ...
    $(document).ready(function() {
        ...
        //css page control
        //$('#btnTrigger').trigger('click');//$('#btnTrigger').click();//show menu ทันทีที่ load page
        
        //แสดงสถานะ onlineuser
        $.when($.fn.def_OnlineUser()).done(function(data){
            $("#brand div:nth-child(2)").empty()
                .append("<font color='lightgreen'>online:</font>&nbsp;"+data.pname);
        });
        ...
        //show hide menu left
        $('#btnShowHideMN').css('display', 'block');
        $('#btnShowHideMN').click(function(e){
            e.preventDefault();
            e.stopPropagation(); 
            var mn = $('div.nav-side-menu');
            if(mn.hasClass('hidden')){//show เมนู 
                $("#myContent").toggleClass('col-xs-12 col-md-9');
                $("#myContent").removeClass('col-xs-12 col-lg-12');
                $('.nav-side-menu').toggleClass('col-xs-12 col-md-3');
                $('.nav-side-menu').animate({
                    left: '0px'
                }, 500);
                mn.removeClass('hidden').show();
            }else{//hide เมนู
                $("#myContent").removeClass('col-xs-12 col-md-9');
                $("#myContent").addClass('col-xs-12 col-lg-12');
                $('.nav-side-menu').removeClass('col-xs-12 col-md-3');
                $('.nav-side-menu').animate({
                    left: '-200px'
                }, 500);
                mn.toggleClass('hidden').hide();
            }
        });
